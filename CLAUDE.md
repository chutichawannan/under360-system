...
### 🧭 ใครถือช่องทางไหน (นัทบอกเอง 15 ก.ย. 2569 — เปลี่ยนจากเดิมที่พลอยถือทั้งหมด)

| ช่องทาง | ใครถือ | ทำแบบไหน |
|---|---|---|
| **Instagram** | **พลอย** | **ออร์แกนิก — ไม่ได้ยิงแอด** |
| **Facebook** | **นัท** | ยิงแอด (ห้อง 06 เป็นคนทำให้) |
| **Google** | **นัท** | ยังไม่เริ่ม แต่นัทยืนยันว่าจะลงไปแน่ |

**เดิมพลอยทำมาเก็ตติ้งทั้งหมด — ตอนนี้นัทเข้ามาถือฝั่งยิงแอดเอง** (ไม่ใช่การแย่ง territory แต่เป็นการแบ่งกันตามที่นัทเล่า)

⚠️ **ผลต่อการวัดผล:** ออเดอร์ที่มาจากโพสต์ออร์แกนิกของพลอย กับที่มาจากแอดของนัท **หน้าตาเหมือนกันหมดใน DB (`direct/none`)** ถ้าลิงก์ไม่ติด UTM
→ ทางปิด: ลิงก์ของพลอยใช้ `utm_source=ig&utm_medium=organic&utm_campaign=ploy` (ฝากกะปันไปขอแล้ว 15 ก.ย.)
→ **ห้ามสรุปว่ายอดที่ตามรอยไม่ได้มาจากแอด** — มันปนกันอยู่ 2 ทางเป็นอย่างน้อย
