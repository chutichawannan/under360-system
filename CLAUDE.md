...
## 🚦 Current Version: v0.4.13 (✅ push แล้ว — live บน Vercel, commit ล่าสุด `608b0aa` — ⚠️ รอรัน 2 SQL: `scripts/sql_promo_scope.sql`, `scripts/sql_packages_rls.sql`)
