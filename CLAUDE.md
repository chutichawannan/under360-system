...
## 🚀 Current Version: u0.4.28 (LIFF perf + fix ผลเทส set builder) + เว็บ live (m0.2) — ✅ push แล้ว
...
- **ค่าส่ง (แก้ 16 ก.ค. โดยเอิธ):** คำว่า "subsidize/ซับซิไดซ์ค่าส่ง 30-50K/เดือน" = **context ภายในเท่านั้น ห้ามใช้กับลูกค้า** · customer-facing reframe เป็น **"ค่าส่งคุ้ม/ถูก"** (ร้านรับส่วนเกิน ลูกค้าจ่ายไม่เกิน ~200฿ · MP weekly/monthly ส่งฟรี) · ⚠️ **ห้ามเคลม "ถูกที่สุด"/superlative** จนกว่าจะ verify จริง
...
> **ตัวเลขที่ใหญ่กว่าทุกเรื่อง:** LINE OA ~20,000 followers (สะสม 10 ปี) → ลูกค้าจริง **<100 คน/สัปดาห์ (<0.5%)** · ยอดตกหนัก **ทั้งลูกค้าเก่า+ใหม่พร้อมกัน** (ไม่ใช่เพราะเดินทาง — พลอยอัพโซเชียล/นัท broadcast ตลอด)
...
### 👀 Influencer Watchlist (ขยาย scope เอิธ · execute = พลอย · 21 ก.ค.)
- **@chalad.gin** (Chaladgin) — นักกำหนดอาหารวิชาชีพ · 1.9K followers แต่ reel 4K-17K views (**reach 2-9 เท่า = pre-breakout**) · bio ตรง positioning เรา ("กินดีไม่จำเป็นต้องคลีนอย่างเดียว") · credential = authority signal สำหรับ GEO/validate สเปค HP/LC · มี openlink.co (รับงานแบรนด์) · 💤 ยังไม่ติดต่อ · มุม collab: **"HP vs LC เลือกยังไง"** (โปรโมทคู่ตามกฎแบรนด์) · ⚠️ **bet ไม่ใช่ channel** follower ยังเล็ก อย่าคาดหวังยอดทันที
- **discovery เพิ่ม (พลอย · ฟรี):** IG ปิด public search → ใช้ "บัญชีที่แนะนำ" (▾ ข้าง Follow) จาก @chalad.gin ขุดต่อเป็นทอดๆ · เกณฑ์คัด: view/follower >2 เท่า · bio ไม่ใช่คลีนจัด · เน้นให้ความรู้ · **monitoring อัตโนมัติ = เอิธ** (ระยะยาว IG Business Discovery endpoint — verify API ก่อนสร้าง Meta เปลี่ยนบ่อย)
