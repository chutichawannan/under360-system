...
## 🚀 Current Version: **u0.4.42 · a0.6 · f0.1 · r0.1 · doc v6.13** — ✅ **u-track cutover-prep ขึ้น main (31 ก.ค.): identity/CRM + register no-OTP + KQ/แมส fix + Lalamove scaffold** (9 งาน · ดู changelog ท้ายไฟล์) · 🔄 P-track sync (working บน branch)
