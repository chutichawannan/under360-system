...
## 🚦 Current Version: v0.4.12 (✅ push แล้ว — live บน Vercel, commit ล่าสุด `0be063f` — ⚠️ รอรัน 1 SQL: `scripts/sql_promo_scope.sql` — ดูหัวข้อ "🎁 Promo Scope + โค้ดแนะนำ" ด้านล่าง)
