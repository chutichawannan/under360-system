...
> ⚠️ **ชื่อไฟล์ในเอกสารนี้ 8 ตัวชี้ไปที่ของที่ไม่มีอยู่จริง (CC ตรวจครบ 95 ชื่อ เทียบ `origin/main` เมื่อ 21 ส.ค. 2026)**
> **เอกสารกลางไม่ได้โกหก — มันคือ "บันทึกตอนนั้น" ไม่ใช่ "สถานะตอนนี้"** เขียนตอนที่จริง แล้วไม่มีใครกลับมาลบตอนของหาย/เปลี่ยนชื่อ
> 🔑 **ก่อนแตะไฟล์ไหนตามที่เอกสารบอก ให้เช็คก่อนว่ามีจริง** (`git ls-tree -r origin/main | grep ชื่อไฟล์`)
>
> | ที่เอกสารอ้าง | ความจริง |
> |---|---|
> | `api/line-webhook.js` | ✅ **แก้แล้ว 21 ส.ค.** — ของจริงคือ `.mjs` · **นามสกุลผิดนี้เคยทำให้ CC แตะผิดไฟล์มาแล้ว 14 ส.ค.** |
> | `kidneycare.html` | ไม่เคยเข้า repo — **M กำลังนำเข้า (21 ส.ค.)** |
> | `api/post.js` | เอกสารเขียนเองว่า "optional ประเมินก่อนทำ" = **ไม่เคยทำ** |
> | `ploy_workspace.html` · `content_plan.html` | **เป็น backlog ยังไม่ทำ** แต่เขียนเหมือนมีอยู่ |
> | `docs/fah_instructions.md` | เอกสารบอกเองว่า "ยังไม่เขียน" แต่ถูกอ้างเป็นไฟล์ |
> | `HANDOFF_WEB.md` · `CLAUDE_CODE_BRIEF_widget.md` · `CLAUDE_CODE_HANDOFF*.md` | **ไฟล์ส่งงานเก่า ลบไปแล้ว** — เนื้อหาถูกย่อยเข้าเอกสารนี้หมดแล้ว ไม่ต้องตามหา |
>
> 🟡 **อีก 16 ตัวไม่ใช่ปัญหา — ตั้งใจไม่อยู่ใน git** (มีจริงในเครื่อง): `docs/UNDER360_MASTERNOTE_v6_7.md` · `docs/UNDER360_HISTORY.md` · `finance/*` · `web/eath/*` · `nut_personal_profile.md`
...
- **ไฟล์:** `kitchen_console.html` · `api/kitchen-console.js` · `api/line-webhook.mjs` · `scripts/sql_kitchen_translate.sql`
