...
## 🚦 Current Version: v0.4.15 (✅ push แล้ว — live บน Vercel, commit ล่าสุด `486fa3b` + บั๊กลากเรียง PTT — ⚠️ รอรัน 3 SQL: `scripts/sql_promo_scope.sql`, `scripts/sql_packages_rls.sql`, `scripts/sql_promo_stack.sql`)
