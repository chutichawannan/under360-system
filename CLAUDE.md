...
## 🚦 Current Version: v0.4.16 (✅ push แล้ว — live บน Vercel, commit ล่าสุด `c8ea61a` — ⚠️ รอรัน 3 SQL: `scripts/sql_promo_scope.sql`, `scripts/sql_packages_rls.sql`, `scripts/sql_promo_stack.sql`)
