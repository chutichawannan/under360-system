...
### ⚠️ ยังไม่ได้สร้าง — รอนัทรัน SQL
`activity_log` — ตาราง log กิจกรรม (ดูหัวข้อ "📜 Activity Log" ด้านล่าง) — โค้ดที่เขียนรองรับกรณีตารางยังไม่มีอยู่แล้ว (catch error, แถบ log โชว์ "ยังไม่มีประวัติ" เฉยๆ ไม่พัง) แต่ log จะยังไม่เริ่มเก็บจนกว่าจะรัน `scripts/sql_activity_log.sql`
