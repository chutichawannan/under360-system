...
ok('เก็บชื่อคนใส่ไว้ด้วย', K2.indexOf('by:USER') >= 0 && K2.indexOf('เป็นคนใส่') >= 0);
...
ok('เลขในตู้ที่ไม่ได้มาจากการนับ ติดป้ายในหน้าวางแผนด้วย',
  K2.indexOf('เลขในตู้นี้ไม่ได้มาจากการนับใน 7 วัน') >= 0);
