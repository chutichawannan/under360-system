...
try {
  ...
  // 16 ก.ย.: ด่าน ฿5,000 ชนแล้ว นัทเคาะเอง — โยกงบ N→C ไม่ลดงบรวม · ด่านถัดไป ฿10,000
  if (spend > 10000) flags.push(`แคมเปญใช้ทะลุ ฿10,000 แล้ว (฿${spend.toFixed(0)}) → **ต้องให้นัทเคาะใหม่**`);
