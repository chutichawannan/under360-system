 ...
 */
const TEST_SUBSTRINGS = ['test', 'ทดลอ', 'schema', 'เทส'];
// 'เทส' เพิ่ม 15 ส.ค. หลัง `U-0817-010 "Nut เทส"` หลุดเข้าใบทวงเงิน
// ✅ verify ก่อนเพิ่ม: query ชื่อที่มี "เทส" ทั้งระบบ = 39 ใบ **เป็นออเดอร์เทสทั้งหมด ไม่มีลูกค้าจริง**
//    ("เทส" · "Nut เทสสสส" · "เทส กรุงเทพ" · "เทส เพอรี่" · "[TEST-CC] เทส..." ฯลฯ)
