...
// ── คู่ที่ "ผมอ่านชื่อเองทั้ง 310 ชื่อ" แล้วเห็นว่าน่าจะเป็นตัวเดียวกัน ──
// ⚠️ รอบแรกผมใช้สคริปต์เทียบตัวอักษร → ได้คู่ขยะเพียบ (ผงทำหมูแดง ↔ ผักชี) นัทจับได้ 18 ก.ย.
//    รอบนี้คัดด้วยความเข้าใจ ไม่ใช่ความคล้ายของตัวหนังสือ
const HAND_PAIRS = [[0,8],[3,5],[14,15],[17,31],[21,29],[16,24],[30,32],[37,40],[52,57],[57,60],[59,75],[43,63],[45,66],[42,53],[76,153],[70,82],[71,80],[74,77],[61,65],[68,79],[46,54],[47,67],[107,108],[109,113],[113,119],[158,159],[111,114],[116,174],[128,130],[131,132],[136,137],[141,145],[145,151],[133,147],[139,157],[146,150],[167,169],[169,175],[164,180],[162,64],[64,166],[178,181],[168,173],[295,306],[298,308],[284,301],[183,199],[185,204],[195,218],[218,239],[194,213],[198,220],[200,263],[263,214],[214,209],[234,242],[240,262],[201,275],[210,252],[188,217],[217,249],[222,237],[237,264],[228,247],[231,258],[197,244],[229,253],[232,265],[233,235],[250,277],[254,278],[254,215],[266,268],[186,266],[92,255],[121,125],[123,109],[122,85],[84,103],[97,98],[98,100],[16,269],[251,271],[44,179],[6,280],[280,281],[38,48],[11,23],[41,64],[192,195]];
/** หมวดที่ผมจัดผิดเอง — ย้ายให้เลย ไม่ต้องรบกวนนัท */
const FIXCAT = {
  10:'🥬 ผัก/สมุนไพร', 26:'🥬 ผัก/สมุนไพร', 62:'🥬 ผัก/สมุนไพร', 83:'🥬 ผัก/สมุนไพร',
  89:'🥬 ผัก/สมุนไพร', 92:'🥬 ผัก/สมุนไพร',
  6:'🧂 เครื่องปรุง', 34:'🧂 เครื่องปรุง', 35:'🧂 เครื่องปรุง', 81:'🧂 เครื่องปรุง',
  146:'🧂 เครื่องปรุง', 150:'🧂 เครื่องปรุง', 152:'🧂 เครื่องปรุง', 154:'🧂 เครื่องปรุง',
  259:'🧂 เครื่องปรุง', 260:'🧂 เครื่องปรุง',
  285:'📦 ไม่ใช่วัตถุดิบ (บรรจุภัณฑ์/ของใช้)',
  41:'🥫 ของแห้ง/กระป๋อง/ของถนอม', 64:'🥫 ของแห้ง/กระป๋อง/ของถนอม', 13:'🥫 ของแห้ง/กระป๋อง/ของถนอม',
  171:'🧂 เครื่องปรุง',
  122:'📦 ไม่ใช่วัตถุดิบ (บรรจุภัณฑ์/ของใช้)', 124:'🍚 ข้าว/แป้ง/เส้น',
  110:'🍚 ข้าว/แป้ง/เส้น', 117:'🍚 ข้าว/แป้ง/เส้น', 153:'🍚 ข้าว/แป้ง/เส้น', 226:'🍚 ข้าว/แป้ง/เส้น',
};
for (const o of out) if (FIXCAT[o.id]) o.c = FIXCAT[o.id];
const PAIRS = HAND_PAIRS.map(([a, b]) => ({ a, b, s: 100 }));
