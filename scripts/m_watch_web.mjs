...
const CHECKS = [
  ...
  ['/jay', 'หน้าคอร์สเจ 2569', [
    ['Meta Pixel',      /949287485825587/,        'แอดที่ยิงเข้าหน้านี้จะวัดผลไม่ได้'],
    ['Google Ads',      /AW-872118373/,           'แอด Google จะนับ conversion ไม่ได้'],
    /* 8 ก.ย. เปลี่ยนดีไซน์หน้าเจ — เมนูย้ายจากตัวแปร JAY_ROUNDS มาเป็น HTML ตรงๆ ใน .round-panel
       กฎเดิมเลยขึ้นแดงทั้งที่เมนูอยู่ครบ · เช็คของที่ลูกค้าเห็นจริงแทนชื่อตัวแปร */
    ['เมนูแยกรายรอบ',   /round-panel/,            'ลูกค้าไม่เห็นว่าแต่ละรอบได้กินอะไร'],
    ['ตัวนับสถิติ',     /u360track/,             'หน้านี้จะไม่บันทึกสถิติ = ยิงแอดแล้วมองไม่เห็นว่ามีคนเข้าไหม'],
    ['แคตตาล็อกเมนู',   /class="dish"/,        'หน้าเมนูหาย = จุดขายหลักหาย'],
    ['ของแถมแก้วสลัด',  /แก้วสลัด/,               'ห้องเจเคาะไว้ว่าแถม แต่หน้าเว็บไม่บอก = ลูกค้าไม่รู้ว่าได้'],
    ['โลโก้ธงเจ',       /jay-logo.svg/,          'หน้าอีเวนต์ไม่มีโลโก้ = ดูไม่ออกว่าเป็นของเทศกาล'],
    ['ราคา Early Bird', /4,190/,                  'ราคาหลักหาย'],
    ['ปุ่มจอง → LIFF',  /liff\.line\.me\/2011148232/, 'ลูกค้ากดจองแล้วไปผิดที่'],
  ]],
  ['/blog', 'หน้ารวมบทความ', [
