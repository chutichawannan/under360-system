...
//       ② **ขอบวันตรงกับไฟล์จริง** — ดัชนีแบ่งวันตามลำดับแชท ทำให้รูปวันเดียวกัน
//          กระจายอยู่คนละตาราง (25 ส.ค. ดิบมี 18 · ตาราง 25 มี 16 · อีก 2 อยู่ในตาราง 24)
//          ⚠️ นั่น **ไม่ใช่รูปหาย** — เคยสรุปผิดว่าหายมาแล้ว ดูหัวข้อถอนคำใน
//          docs/KITCHEN_PHOTO_202425AUG_REPAIRED.md
...
console.log('');
console.log('🔴 กฎเหล็กที่ได้มาแบบเจ็บตัว (26 ส.ค. — ผมสรุปผิดเพราะดูจากแผ่นย่อ):');
console.log('   แผ่นรวมนี้เซลล์ละ 300px = ใช้กวาดสายตาเท่านั้น **ห้ามใช้ตัดสิน**');
console.log('   ทุกครั้งที่จะขีดเส้นแบ่งจาน ต้องเปิดใบที่คร่อมรอยต่อแบบใหญ่ก่อนเสมอ');
console.log('   (เคยอ่าน #03/#04 ว่าเป็นปลากระพง พอเปิดใหญ่กลายเป็นเส้นหมี่คลุกอกไก่ฉีก)');
console.log('');
