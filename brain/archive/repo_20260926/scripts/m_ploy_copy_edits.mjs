...
/* ข้อ 4 (บล็อกราคา) = **เลขาเดาเอาจากภาพวงแดง** — นัทพิมพ์ค้างแค่คำว่า 'แก้ไข' ไม่มีเนื้อหา
   ข้อ 5 (บรรทัด 24 ชม.) = ท่อนท้ายชนกฎแบรนด์ CC กำลังถามนัทว่าจะใช้คำไหน
   → ตั้ง SKIP_UNCONFIRMED=1 เพื่อทำเฉพาะข้อ 1,2,3,6 ที่ยืนยันแล้ว */
const SKIP = process.env.SKIP_UNCONFIRMED === '1';
...
/* ④ บล็อกราคา → ตารางเทียบ 2 ฝั่ง (ยังไม่ยืนยัน) */
if(!SKIP){
...
} else console.log('  ⏸️  ④ ข้าม — ยังไม่ยืนยันว่านัทหมายถึงบล็อกนี้');

/* ⑤ บรรทัด 24 ชม. (ยังไม่ยืนยันคำ) */
if(!SKIP){
...
ok('⑤ บรรทัด 24 ชม.');
} else console.log('  ⏸️  ⑤ ข้าม — รอนัทเคาะว่าจะใช้คำไหน');
